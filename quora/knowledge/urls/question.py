...
urlpatterns = [
    ...
    path('question/<int:pk>', detail.QuestionDetail.as_view(), name='question-detail'),
    ...
    path('question/<int:pk>/update/', update.QuestionUpdate.as_view(), name='question_update'),
    path('question/<int:pk>/delete/', delete.QuestionDelete.as_view(), name='question_delete'),
